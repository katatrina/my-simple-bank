...
type Store interface {
	Querier
	TransferMoneyTx(ctx context.Context, arg TransferMoneyParams) (TransferMoneyResult, error)
}
...
func (store *SQLStore) TransferMoneyTx(ctx context.Context, arg TransferMoneyParams) (TransferMoneyResult, error) {
